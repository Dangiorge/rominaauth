...
export async function PUT(req, { params }) {
  ...
  const updatePayload = {
    ...
    description: "description" in body ? body.description : before.description,
    category_id: "category_id" in body ? body.category_id : before.category_id,
    item_type: itemType,
    ...enforcedFlags,
    base_uom_id: body.base_uom_id ?? before.base_uom_id,
    purchase_uom_id:
      "purchase_uom_id" in body ? body.purchase_uom_id : before.purchase_uom_id,
    sales_uom_id:
